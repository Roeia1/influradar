...
const LP_I18N = {
  he: {
    ...
    /* ---- Food landing ---- */
    "f.title": "Zarkor — יוצרי תוכן קולינריים ישראלים שכבר מפרסמים על מקומות כמוכם",
    "f.meta": "חיפוש בין אלפי יוצרי תוכן קולינריים ישראלים לפי עיר, נישה ומעורבות. ראו מי כבר מתייג את המתחרים שלכם. פנייה ישירה מהמותג — בלי סוכנות, בלי עמלה.",
    "f.eyebrow": "למותגי מזון, מסעדות ובתי קפה בישראל",
    "f.h1a": "מצאו ",
    "f.h1grad": "יוצרי תוכן קולינריים",
    "f.h1b": " שכבר מפרסמים על מקומות כמו שלכם.",
    "f.lede": "חיפוש בין אלפי יוצרי תוכן ישראלים לפי עיר, נישה ומעורבות. ראו מי כבר מתייג את המתחרים שלכם. פנו אליהם ישירות מהמותג — בלי סוכנות, בלי עמלה, בלי לנחש.",
    ...
    "f.r2.p": "שיעור מעורבות אמיתי, קצב פרסום, ותמהיל שפה מתוך הכיתובים עצמם — לא נתוני קהל שדורשים הסכמת יוצר התוכן. אתם רואים מי מדבר עם קהל ישראלי שמקשיב.",
    ...
    "a.meta": "30 יוצרי תוכן ישראלים מסוננים ב-30 דקות, לא 12 שעות. חיפוש בביו בעברית, מרחבי עבודה לכמה לקוחות, בריפים בכמות וייצוא PDF בלייבל שלכם.",
    "a.eyebrow": "לסוכנויות שיווק משפיענים בישראל",
    "a.h1a": "30 ",
    "a.h1grad": "יוצרי תוכן ישראלים",
    "a.h1b": " מסוננים ב-30 דקות — לא 12 שעות גלילה.",
    "a.lede": "חיפוש בין אלפי יוצרי תוכן ישראלים לפי נישה, עיר ומעורבות. חיפוש בביו בעברית שהכלים הגלובליים מפספסים. מרחבי עבודה לכמה לקוחות, בריפים בכמות, וייצוא PDF בלייבל שלכם לפגישות.",
    ...
    "a.r2.p": "Modash ו-Heepsy לא קוראים עברית טוב. אנחנו מחפשים בתוך הביו והכיתובים בעברית, אז יוצר תוכן שכותב על עצמו ״קומיקאית״ באמת יעלה בתוצאות.",
    "a.r2.l1": "התאמת ביו וכיתובים בעברית",
    "a.r2.l2": "כרטיס יוצר תוכן RTL מלא",
  ...
  en: {
    ...
    "f.meta": "Search thousands of Israeli food content creators by city, niche and engagement. See who already tags your competitors. Reach out from your brand — no agency, no commission.",
    ...
    "f.lede": "Search thousands of Israeli content creators by city, niche, and engagement. See which ones already tag your competitors. Reach out from your brand — no agency, no commission, no guessing.",
    "f.cta": "Book 15 min",
    ...
    "f.r2.p": "Real engagement rate, posting cadence, and language mix pulled from the captions themselves — not audience data that needs content-creator opt-in. You see who's talking to an Israeli audience that's actually listening.",
    ...
    "a.meta": "30 vetted Israeli content creators in 30 minutes, not 12 hours. Hebrew-native bio search, multi-client workspaces, bulk briefs and white-label PDF exports.",
    ...
    "a.lede": "Search thousands of Israeli content creators by niche, city, and engagement. Hebrew-native bio search that global tools miss. Multi-client workspaces, bulk briefs, white-label PDF exports for client meetings.",
    "a.cta": "Book 15 min",
    ...
    "a.r2.p": "Modash and Heepsy don't read Hebrew well. We search inside the bio and captions in Hebrew, so a content creator who calls themselves “קומיקאית” actually shows up.",
    "a.r2.l1": "Hebrew bio & caption matching",
    "a.r2.l2": "Full RTL content-creator card",
