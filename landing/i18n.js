...
const LP_I18N = {
  he: {
    ...
    "f.r2.p": "שיעור מעורבות אמיתי וקצב פרסום — לא נתוני קהל שדורשים הסכמת יוצר התוכן. אתם רואים מי מדבר עם קהל ישראלי שמקשיב.",
  ...
  en: {
    ...
    "f.r2.p": "Real engagement rate and posting cadence — not audience data that needs content-creator opt-in. You see who's talking to an Israeli audience that's actually listening.",
