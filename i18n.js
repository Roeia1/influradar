...
const I18N = {
  en: {
    ...
    "brand.land.band.i5.title": "Brand safety, built-in",
    "brand.land.band.i5.body": "Every creator is screened for tone-of-voice, prior brand partnerships, and content flags. See competitor partnerships before you brief — no awkward overlap surprises.",
    ...
    "brand.plan.p.f7": "Brand-safety screening + competitor partnerships",
  ...
  he: {
    ...
    "brand.land.band.i5.title": "בטיחות מותג מובנית",
    "brand.land.band.i5.body": "כל יוצר נסרק לטון דיבור, שיתופי פעולה קודמים עם מותגים, וסיגנלים של תוכן בעייתי. תראו שיתופי פעולה עם מתחרים לפני שאתם נותנים בריף — בלי הפתעות מביכות.",
    ...
    "brand.plan.p.f7": "סינון בטיחות מותג + שיתופי פעולה עם מתחרים",
