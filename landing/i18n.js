...
const LP_I18N = {
  he: {
    ...
    /* ---- Food landing ---- */
    "f.title": "Zarkor — קריאייטורי אוכל ישראלים שכבר מפרסמים על מקומות כמוכם",
    "f.meta": "חיפוש בין אלפי קריאייטורי אוכל ישראלים לפי עיר, נישה ומעורבות. ראו מי כבר מתייג את המתחרים שלכם. פנייה ישירה מהמותג — בלי סוכנות, בלי עמלה.",
    "f.eyebrow": "למותגי מזון, מסעדות ובתי קפה בישראל",
    "f.h1a": "מצאו ",
    "f.h1grad": "קריאייטורי אוכל",
    "f.h1b": " שכבר מפרסמים על מקומות כמו שלכם.",
    "f.lede": "חיפוש בין אלפי קריאייטורים ישראלים לפי עיר, נישה ומעורבות. ראו מי כבר מתייג את המתחרים שלכם. פנו אליהם ישירות מהמותג — בלי סוכנות, בלי עמלה, בלי לנחש.",
    "f.cta": "קביעת שיחה של 15 דקות",
    "f.fn.body": "אני בונה את Zarkor כי כל צוות מותג ישראלי שדיברתי איתו אמר אותו דבר: למצוא קריאייטורים מקומיים שבאמת מזיזים לקוחות זה איטי, ידני, וברובו ניחוש. אני עדיין לא מוכר כלום — אני עושה שיחות של 15 דקות עם מותגים וסוכנויות כדי להבין מה באמת שבור לפני שאני בונה עוד. אם איתור קריאייטורים ישראלים זה כאב אצלכם, אשמח לשמוע על זה.",
    "f.r2.kick": "מעורבות אמיתית",
    "f.r2.h": "לא רק כמה עוקבים — כמה מהם באמת מגיבים.",
    "f.r2.p": "שיעור מעורבות אמיתי, קצב פרסום, ותמהיל שפה מתוך הכיתובים עצמם — לא נתוני קהל שדורשים הסכמת קריאייטור. אתם רואים מי מדבר עם קהל ישראלי שמקשיב.",
    "f.r2.l1": "שיעור מעורבות מ-30 הימים האחרונים",
    "f.r2.l2": "קצב פרסום ועקביות",
    "f.r2.l3": "תמהיל עברית/אנגלית מתוך הכיתובים",
    "f.r2.he": "עברית 78%",
    "f.r2.en": "אנגלית 22%",
    "f.r2.recent": "מעורבות ב-8 הפוסטים האחרונים",
    "f.r3.kick": "פנייה בקול שלכם",
    "f.r3.h": "בריף מהמייל של המותג שלכם — בלי מתווך.",
    "f.r3.p": "טיוטה בנימה של המותג, ערוכה ומוכנה. נשלחת ישירות מכתובת המייל שלכם, לא דרך סוכנות ולא דרכנו. אנחנו מקשרים — העסקה היא ביניכם לבין הקריאייטור.",
    ...
    "f.r3.msub": "נעביר את הבריף לקריאייטורית ונציג את התגובה בתיבה שלכם. מעקב סטטוס ברשימות השמורות.",
    ...
    "f.r4.h": "כל הקריאייטורים והסטטוסים — במקום אחד.",
    ...
    "f.r4.l2": "סטטוס פנייה לכל קריאייטור",
    "f.r4.l3": "הצוות רואה את אותו מצב",
    "f.r4.listname": "רשימת אביב",
    "f.r4.listsub": "5 קריאייטורים · עודכן היום",
    ...
    "f.r4.cSt": "סטטוס",
    "f.final.h": "איתור קריאייטורים ישראלים לא צריך להיות ניחוש.",

    /* ---- Agency landing ---- */
    "a.title": "Zarkor — כיסוי קריאייטורים ישראלים שהכלים הגלובליים מפספסים",
    "a.meta": "30 קריאייטורים ישראלים מסוננים ב-30 דקות, לא 12 שעות. חיפוש בביו בעברית, מרחבי עבודה לכמה לקוחות, בריפים בכמות וייצוא PDF בלייבל שלכם.",
    "a.eyebrow": "לסוכנויות שיווק משפיענים בישראל",
    "a.h1a": "30 ",
    "a.h1grad": "קריאייטורים ישראלים",
    "a.h1b": " מסוננים ב-30 דקות — לא 12 שעות גלילה.",
    "a.lede": "חיפוש בין אלפי קריאייטורים ישראלים לפי נישה, עיר ומעורבות. חיפוש בביו בעברית שהכלים הגלובליים מפספסים. מרחבי עבודה לכמה לקוחות, בריפים בכמות, וייצוא PDF בלייבל שלכם לפגישות.",
    "a.cta": "קביעת שיחה של 15 דקות",
    "a.fn.body": "אני בונה את Zarkor כי כל סוכנות שדיברתי איתה אמרה אותו דבר: הכלים הגלובליים בקושי מכסים את ישראל, אז חצי מעבודת האיתור עדיין ידנית. אני עדיין לא מוכר כלום — אני עושה שיחות של 15 דקות עם מותגים וסוכנויות כדי להבין מה באמת שבור לפני שאני בונה עוד. אם איתור קריאייטורים ישראלים זה כאב אצלכם, אשמח לשמוע על זה.",
    "a.r1.fsearch": "חיפוש בביו (עברית)",
    "a.r1.fcity": "עיר",
    "a.r1.fniche": "נישה",
    "a.r1.fer": "שיעור מעורבות",
    "a.r1.ffol": "טווח עוקבים",
    "a.r2.kick": "חיפוש בעברית",
    "a.r2.h": "חיפוש בביו בעברית — בדיוק מה שהכלים הגלובליים מפספסים.",
    "a.r2.p": "Modash ו-Heepsy לא קוראים עברית טוב. אנחנו מחפשים בתוך הביו והכיתובים בעברית, אז קריאייטור שכותב על עצמו ״קומיקאית״ באמת יעלה בתוצאות.",
    "a.r2.l1": "התאמת ביו וכיתובים בעברית",
    "a.r2.l2": "כרטיס יוצר RTL מלא",
    "a.r2.l3": "סינון לפי עיר, נישה, מעורבות",
    ...
    "a.r4.selected": "20 קריאייטורים נבחרו",
    ...
    "a.r5.l2": "נתוני קריאייטור ופוסטים לדוגמה",
  ...
  en: {
    ...
    /* ---- Food landing ---- */
    "f.title": "Zarkor — find Israeli food creators who already post about places like yours",
    "f.meta": "Search thousands of Israeli food creators by city, niche and engagement. See who already tags your competitors. Reach out from your brand — no agency, no commission.",
    "f.eyebrow": "For Israeli food brands, restaurants & cafés",
    "f.h1a": "Find ",
    "f.h1grad": "food creators",
    "f.h1b": " who already post about places like yours.",
    "f.lede": "Search thousands of Israeli creators by city, niche, and engagement. See which ones already tag your competitors. Reach out from your brand — no agency, no commission, no guessing.",
    "f.cta": "Book 15 min",
    "f.fn.body": "I'm building Zarkor because every Israeli brand team I've talked to said the same thing: finding local creators who actually move customers is slow, manual, and mostly guesswork. I'm not selling anything yet — I'm running 15-minute calls with brands and agencies to learn what's really broken before I build more. If sourcing Israeli creators is a pain for you, I'd genuinely like to hear about it.",
    "f.r2.kick": "Real engagement",
    "f.r2.h": "Not just how many followers — how many actually engage.",
    "f.r2.p": "Real engagement rate, posting cadence, and language mix pulled from the captions themselves — not audience data that needs creator opt-in. You see who's talking to an Israeli audience that's actually listening.",
    "f.r2.l1": "Engagement rate over the last 30 days",
    "f.r2.l2": "Posting cadence & consistency",
    "f.r2.l3": "Hebrew/English mix from captions",
    "f.r2.he": "Hebrew 78%",
    "f.r2.en": "English 22%",
    "f.r2.recent": "Engagement, last 8 posts",
    "f.r3.kick": "Outreach in your voice",
    "f.r3.h": "A brief from your brand's inbox — no middleman.",
    "f.r3.p": "A draft in your brand's voice, edited and ready. Sent straight from your email — not through an agency, and not through us. We make the intro; the deal is between you and the creator.",
    ...
    "f.r3.msub": "We'll deliver the brief to the creator and surface their response in your inbox. Track status in Saved lists.",
    ...
    "f.r4.h": "Every creator and status — in one place.",
    ...
    "f.r4.l2": "Outreach status per creator",
    "f.r4.l3": "Your team sees the same state",
    "f.r4.listname": "Spring shortlist",
    "f.r4.listsub": "5 creators · updated today",
    ...
    "f.r4.cSt": "Status",
    "f.final.h": "Sourcing Israeli creators shouldn't be guesswork.",

    /* ---- Agency landing ---- */
    "a.title": "Zarkor — Israeli creator coverage that global tools miss",
    "a.meta": "30 vetted Israeli creators in 30 minutes, not 12 hours. Hebrew-native bio search, multi-client workspaces, bulk briefs and white-label PDF exports.",
    "a.eyebrow": "For Israeli influencer-marketing agencies",
    "a.h1a": "30 vetted ",
    "a.h1grad": "Israeli creators",
    "a.h1b": " in 30 minutes — not 12 hours of scrolling.",
    "a.lede": "Search thousands of Israeli creators by niche, city, and engagement. Hebrew-native bio search that global tools miss. Multi-client workspaces, bulk briefs, white-label PDF exports for client meetings.",
    "a.cta": "Book 15 min",
    ...
    "a.r2.kick": "Hebrew search",
    "a.r2.h": "Hebrew bio search — exactly what the global tools miss.",
    "a.r2.p": "Modash and Heepsy don't read Hebrew well. We search inside the bio and captions in Hebrew, so a creator who calls themselves “קומיקאית” actually shows up.",
    "a.r2.l1": "Hebrew bio & caption matching",
    "a.r2.l2": "Full RTL creator card",
    "a.r2.l3": "Filter by city, niche, engagement",
    ...
    "a.r4.selected": "20 creators selected",
    ...
    "a.r5.l2": "Creator stats & sample posts",
