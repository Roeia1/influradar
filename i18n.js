...
const I18N = {
  en: {
    ...
    "briefs.sub": "Every brief Pantry & Co. has sent, grouped by campaign. Drag a card to update its status.",
    "briefs.new": "+ Send new brief",
    "briefs.workspace": "Pantry & Co. · Marketing ▾",
    "briefs.footer": "All briefs are sent directly from your brand inbox. No middleman, no agency boilerplate.",
    "briefs.col.brief": "Brief sent",
    "briefs.col.responded": "Responded",
    "briefs.col.negotiation": "In negotiation",
    "briefs.col.closed": "Closed-won",
    "briefs.col.declined": "Declined",
    "briefs.col.empty": "No briefs here yet",
    "briefs.stats.briefs": "briefs",
    "briefs.stats.budget": "Budget · ",
    "briefs.stats.committed": "Committed · ",
    "briefs.c1.title": "Spring pantry refresh · April reels",
    "briefs.c1.sub": "Lifestyle creators showcasing the new spring snack & matcha SKUs across Reels and Stories.",
    "briefs.c2.title": "High-protein lineup · Q3 launch",
    "briefs.c2.sub": "Nutrition & fitness creators introducing Pantry & Co.'s new high-protein pasta and snack range.",
    "briefs.sent.3d": "Sent 3d ago",
    "briefs.sent.4d": "Sent 4d ago",
    "briefs.sent.5d": "Sent 5d ago",
    "briefs.sent.6d": "Sent 6d ago",
    "briefs.sent.7d": "Sent 7d ago",
    "briefs.sent.9d": "Sent 9d ago",
    "briefs.sent.12d": "Sent 12d ago",
    "briefs.sent.14d": "Sent 14d ago",
    "creator.linorlab.name": "Linor Levanter",
    "creator.maya_agassi.name": "Maya Agassi",
    "creator.romi_eats.name": "Romi Avni",
    "creator.talya_kaplan.name": "Talya Kaplan",
    "creator.hm_fitnutrition.name": "Hadas & Maayan Lapidot",
    "creator.nitzanjerbi.name": "Nitzan Jerbi Derfler",
    "creator.chen_fitness.name": "Chen Ben David",
    "creator.nivfitfood.name": "Niv Zitayat",
  },
  he: {
    // --- Header / nav ---
    "nav.discover": "גילוי",
    ...
    "briefs.sub": "כל בריף שפאנטרי שלחה, מקובץ לפי קמפיין. גררו כרטיס כדי לעדכן את הסטטוס.",
    "briefs.new": "+ שליחת בריף חדש",
    "briefs.workspace": "פאנטרי · שיווק ▾",
    "briefs.footer": "כל בריף נשלח ישירות מתיבת הדואר של המותג. ללא מתווכים, ללא טקסטים ממוחזרים של סוכנויות.",
    "briefs.col.brief": "בריף נשלח",
    "briefs.col.responded": "התקבל מענה",
    "briefs.col.negotiation": "במשא ומתן",
    "briefs.col.closed": "נסגר בהצלחה",
    "briefs.col.declined": "נדחה",
    "briefs.col.empty": "אין בריפים כאן כרגע",
    "briefs.stats.briefs": "בריפים",
    "briefs.stats.budget": "תקציב · ",
    "briefs.stats.committed": "מחויב · ",
    "briefs.c1.title": "ריענון מזווה לאביב · רילים לאפריל",
    "briefs.c1.sub": "יוצרי לייפסטייל מציגים את חטיפי האביב והמאצ׳ה החדשים ברילים ובסטוריז.",
    "briefs.c2.title": "סדרת חלבון גבוה · השקת רבעון ג׳",
    "briefs.c2.sub": "יוצרי תזונה וכושר חושפים את הפסטה וחטיפי החלבון החדשים של פאנטרי.",
    "briefs.sent.3d": "נשלח לפני 3 ימים",
    "briefs.sent.4d": "נשלח לפני 4 ימים",
    "briefs.sent.5d": "נשלח לפני 5 ימים",
    "briefs.sent.6d": "נשלח לפני 6 ימים",
    "briefs.sent.7d": "נשלח לפני שבוע",
    "briefs.sent.9d": "נשלח לפני 9 ימים",
    "briefs.sent.12d": "נשלח לפני 12 ימים",
    "briefs.sent.14d": "נשלח לפני שבועיים",
    "creator.linorlab.name": "לינור לבנטר",
    "creator.maya_agassi.name": "מאיה אגסי",
    "creator.romi_eats.name": "רומי אבני",
    "creator.talya_kaplan.name": "טליה קפלן",
    "creator.hm_fitnutrition.name": "הדס ומעין לפידות",
    "creator.nitzanjerbi.name": "ניצן ג׳רבי דרפלר",
    "creator.chen_fitness.name": "חן בן דוד",
    "creator.nivfitfood.name": "ניב זיתאית",
  }
};
